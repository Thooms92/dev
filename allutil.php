...
// Префикс
$tableprefix = $UDWBaseconf['udwbase']['aowow'];
...
{
	global $cache_types, $allitems, $allspells, $allachievements, $UDWBaseconf;
...
{
	global $cache_types, $smarty, $allitems, $allspells, $allachievements, $UDWBaseconf;
